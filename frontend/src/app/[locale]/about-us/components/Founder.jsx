  ...
  const Founder = () => {
    const t = useTranslations("AboutPage.founder_section");
    const message = useMessages();

    const teamMembers = Object.keys(message.AboutPage.founder_section.members);
    return (
      <>
        <div className=" mb-10">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4  ">
          {teamMembers.map((member) => {
            const data = message.AboutPage.founder_section.members[member];
            return (
              <div
                key={member}
